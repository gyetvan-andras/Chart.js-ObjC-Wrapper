...
@property (nonatomic,strong) NSColor* scaleLineColor;//@property (nonatomic,strong) NSColor* : "rgba(0,0,0,.1)",
...
@property (nonatomic,strong) NSColor* scaleFontColor;//: "#666",
...
@property (nonatomic,strong) NSColor* tooltipFillColor;//: "rgba(0,0,0,0.8)",
...
@property (nonatomic,strong) NSColor* tooltipFontColor;//: "#fff",
...
@property (nonatomic,strong) NSColor* tooltipTitleFontColor;//: "#fff",
